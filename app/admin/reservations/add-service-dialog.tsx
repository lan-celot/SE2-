...
// Updated services list to match the customer dialog
...
// Added service categories from customer dialog
...
export function AddServiceDialog({
  ...
  // Normalize service names to make comparing them case-insensitive
  const normalizeServiceName = (service: string) => {
    return service.toUpperCase().replace(/_/g, " ");
  }

  // Check if a service already exists in the existing services (case-insensitive)
  ...
  const handleConfirm = () => {
    ...
    // Transform the service IDs to the expected format before sending
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex justify-center space-x-2 pt-2">
              <Button
                ...
                className="bg-red-100 text-red-600 hover:bg-red-200 hover:text-red-700 flex items-center"
              >
